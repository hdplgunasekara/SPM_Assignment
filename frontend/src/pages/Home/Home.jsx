              ...
              <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarExample01">
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item">
                      <a className="nav-link" href="https://mdbootstrap.com/docs/standard/" target="_blank">About Us</a>
                    </li>
                  </ul>
              ...
              <div className="mask" style={{backgroundColor: 'rgba(0, 0, 0, 0.8)'}}>
                <div className="container d-flex align-items-center justify-content-center text-center h-100">
                  <div className="text-white">
                    ...
                    <h5 className="mb-4">The library is a place for everyone to explore, discover, and engage</h5>
                    <a className="btn btn-outline-light btn-lg m-2" href="" role="button" rel="nofollow" target="_blank">Sign In</a>
                    <a className="btn btn-outline-light btn-lg m-2" href="" target="_blank" role="button">Sign Up</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <main className="mt-5">
            <div className="container">
                ...
                <div className="row">
                  <div className="col-md-6 gx-5 mb-4">
                    <div className="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
                      <img src="https://www.pcclean.io/wp-content/gallery/library-hd-wallpapers/919004.jpg" className="img-fluid" />
                      <a href="#!">
                  ...
                  <div className="col-md-6 gx-5 mb-4">
                    <h4><strong>We believe a world-class library should be a direct reflection of the exquisite nature of the content we preserve.</strong></h4>
              ...
              <section className="text-center">
                <h4 className="mb-5"><strong>What We Provide</strong></h4>
                <div className="row">
                  <div className="col-lg-4 col-md-12 mb-4">
                    <div className="card">
                      <div className="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                        <img src="https://images.theconversation.com/files/45159/original/rptgtpxd-1396254731.jpg?ixlib=rb-1.1.0&q=30&auto=format&w=600&h=400&fit=crop&dpr=2" className="img-fluid" />
                        <a href="#!">
                          <div className="mask" style={{backgroundColor: 'rgba(251, 251, 251, 0.15)'}} />
                        </a>
                      </div>
                      <div className="card-body">
                        <h5 className="card-title"><strong>Books</strong></h5>
                  ...
                  <div className="col-lg-4 col-md-6 mb-4">
                    <div className="card">
                      <div className="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                        <img src="https://c0.wallpaperflare.com/preview/422/190/338/announcement-article-articles-copy-coverage.jpg" className="img-fluid" />
                          <div className="mask" style={{backgroundColor: 'rgba(251, 251, 251, 0.15)'}} />
                      </div>
                      <div className="card-body">
                        <h5 className="card-title"><strong>Articles</strong></h5>
                        <p className="card-text">
                          Some quick example text to build on the card title and make up the bulk of the
                          card's content.
                        </p>
                  ...
                  <div className="col-lg-4 col-md-6 mb-4">
                    <div className="card">
                      <div className="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                        <img src="https://saylordotorg.github.io/text_understanding-media-and-culture-an-introduction-to-mass-communication/section_08/9c8126a9510afacdff08bffc2a09c4d3.jpg" className="img-fluid" />
                          <div className="mask" style={{backgroundColor: 'rgba(251, 251, 251, 0.15)'}} />
                      </div>
                      <div className="card-body">
                        <h5 className="card-title"><strong>Magazines</strong></h5>
                        <p className="card-text">
                          Some quick example text to build on the card title and make up the bulk of the
                          card's content.
                        </p>
              ...
              <section className="mb-5">
                <h4 className="mb-5 text-center"><strong>Contact Us</strong></h4>
                  ...
                  <div className="col-md-6">
                    <form>
                      ...
                      <div className="form-outline mb-4">
                        ...
                        <label className="form-label" htmlFor="form3Example3">Contact No</label>
                      </div>
                      {/* Message input */}
                      <div className="form-outline mb-4">
